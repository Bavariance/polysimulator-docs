...
<Steps>
  ...
  <Step title="Configure environment">
    ...
    # Price caching (optional — development defaults shown)
    # Production uses higher values: TTL=180, poll=30, markets=5000
...
| `PRICE_CACHE_TTL_SECONDS` | `45` | Redis price cache TTL (production: 180) |
| `PRICE_POLL_INTERVAL_SECONDS` | `5` | Background price poll interval (production: 30) |
| `MAX_TRACKED_HOT_MARKETS` | `150` | Max markets to track prices for (production: 5000) |
