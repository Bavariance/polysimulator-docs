...
description: "Complete reference for the PolySimulator REST + WebSocket API — generated from a curated in-repo openapi.json snapshot."
---

# API Reference

The PolySimulator API is a **REST + WebSocket** surface. Every endpoint
below is generated from a **curated in-repo snapshot** of the OpenAPI
spec ([`docs-site/openapi.json`](https://github.com/Bavariance/polysimulator/blob/staging/docs-site/openapi.json))
...
<Note>
  ...
  not from the live [`api.polysimulator.com/openapi.json`](https://api.polysimulator.com/openapi.json)
...
[Rate Limits](/concepts/rate-limits) for back-off strategy and the
...
docs via [Mintlify MCP](/introduction#mintlify-mcp) or
[Context7](/introduction#context7).
