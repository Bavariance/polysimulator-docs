...
<Note>
  **Closed beta (ongoing).** API key issuance is cohort-gated. New keys
  ...
  Pro+ accounts that don't yet have a cohort grant:
  ...
  See [Authentication → Closed Beta](/authentication#closed-beta)
