...
| `polysim_clob_client` | You already have a Polymarket bot on [`py-clob-client`](https://github.com/Polymarket/py-clob-client) — this is a **drop-in mirror**; port by changing the import path, the host, and the auth call. |
