...
<Note>
  ...
  **On CLOB V1 vs V2.** Polymarket has archived
  ...
  If you are starting fresh today and intend to go live on Polymarket, write
  against our native `PolySimClient` and treat the move to Polymarket as a real
  port to V2 rather than a base-URL swap. V2 support is on our roadmap; until it
  ships we would rather say so here than let you find out at the point you go live.
  </Warning>
